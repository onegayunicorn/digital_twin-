...
// =============================================================================
// AI Service Logic (DeepSeek V4 Reasoner & Cosmic Engine)
// =============================================================================
...
2. After </think>, provide a clear, rigorous, well-formatted markdown response with LaTeX math formulas.
3. If the user asks to create, synthesize, customize, or model a simulation, append a JSON block at the very end formatted as:
\`\`\`simulation-config
{
...
export async function startServer() {
  ...
  const candidatePaths = [
    ...
    path.resolve(__dirname, "web-app", "dist", "public"),
  ...
  console.log(`[Static Asset Pipeline] Serving from: ${staticPath}`);
  ...
  server.listen(port, host, () => {
    console.log(`Quantum Avatar Simulation Lab listening on http://${host}:${port}/`);
  });
